...
>
> I choose *action* over *inaction*. In this same vain, I value opportunities to learn from failure - sometimes iteration is the path. Stoic perspective is the lens filtering my reality. TLDR; controll what you can (not the inverse). Fear is a chosen reaction (as is hate/love etc ).  
---
### Communication
